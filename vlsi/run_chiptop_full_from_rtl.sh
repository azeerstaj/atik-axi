...
if [[ $# -lt 1 ]]; then
  echo "usage: $0 <extracted-chipyard-root> [extra run_girdap_chiptop_full_openlane.py args...]" >&2
...
OUT_DIR="${OUT_DIR:-$RTL_ROOT/girdap-openlane-out/girdap-chiptop-full-openlane}"

python3 "$SCRIPT_DIR/run_girdap_chiptop_full_openlane.py" \
