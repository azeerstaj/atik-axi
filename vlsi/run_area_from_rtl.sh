...
if [[ $# -lt 1 ]]; then
  echo "usage: $0 <extracted-chipyard-root> [extra run_girdap_area_synth.py args...]" >&2
...
OUT_DIR="${OUT_DIR:-$RTL_ROOT/girdap-openlane-out/girdap-area}"

python3 "$SCRIPT_DIR/run_girdap_area_synth.py" \
