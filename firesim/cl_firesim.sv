...
// Local reset synchronizers for the main-clock AXI DDR bridge logic. Driving
// large Xilinx IP blocks directly from rst_main_n_sync creates very high reset
// fanout and can force reset routes across SLRs.
(* ASYNC_REG = "TRUE" *) logic dramslim0_m_rst_n_r1;
(* ASYNC_REG = "TRUE", max_fanout = 128 *) logic dramslim0_m_rst_n;
always_ff @(negedge rst_main_n or posedge clk_main_a0)
   if (!rst_main_n)
   begin
      dramslim0_m_rst_n_r1 <= 1'b0;
      dramslim0_m_rst_n    <= 1'b0;
   end
   else
   begin
      dramslim0_m_rst_n_r1 <= 1'b1;
      dramslim0_m_rst_n    <= dramslim0_m_rst_n_r1;
   end

(* ASYNC_REG = "TRUE" *) logic dwidth0_rst_n_r1;
(* ASYNC_REG = "TRUE", max_fanout = 128 *) logic dwidth0_rst_n;
always_ff @(negedge rst_main_n or posedge clk_main_a0)
   if (!rst_main_n)
   begin
      dwidth0_rst_n_r1 <= 1'b0;
      dwidth0_rst_n    <= 1'b0;
   end
   else
   begin
      dwidth0_rst_n_r1 <= 1'b1;
      dwidth0_rst_n    <= dwidth0_rst_n_r1;
   end
...
axi_clock_converter_dramslim clock_convert_dramslim_0 (
   ...
   .m_axi_aresetn(dramslim0_m_rst_n),    // input wire m_axi_aresetn
...
axi_dwidth_converter_0 dwidth_adapt_64bits_512bits_0 (
   .s_axi_aclk(clk_main_a0),          // input wire s_axi_aclk
   .s_axi_aresetn(dwidth0_rst_n),    // input wire s_axi_aresetn
