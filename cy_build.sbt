...
// lazy val toyrocc = (project in file("generators/toyrocc")).settings(commonSettings).dependsOn(rocketchip)
lazy val toyrocc = freshProject("toyrocc", file("generators/toyrocc"))
