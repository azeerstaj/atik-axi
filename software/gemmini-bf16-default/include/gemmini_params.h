...
/*
 * Local software header for GemminiFPConfigs.BF16DefaultConfig.
 *
 * This is the default floating-point Gemmini shape: 4x4 BF16 mesh with FP32
 * accumulators. Do not use this header with GemminiBF16Default8Config.
 */
